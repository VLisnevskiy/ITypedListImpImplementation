/**************************************************************************************************
 * <copyright file="XmlQueryStringConverter.cs" company="" author="Vyacheslav Lisnevskiy">
...
namespace ITypedListImpImplementation
{
    ...
    /// </summary>
    public class XmlQueryStringConverter : QueryStringConverter
    {
        /// <summary>
        ...
        public override object ConvertStringToValue(string parameter, Type parameterType)
        {
            ...
            {
                bool bRes;
                if (bool.TryParse(parameter, out bRes))
                {
                    return bRes;
                }

                int iRes;
                if (int.TryParse(parameter, out iRes))
                {
                    return iRes != 0;
                }
